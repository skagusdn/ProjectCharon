...
public:
	...
	// Charon 수정, Z 값까지 고려해서 워터존 찾기. 
	static UE_API TSoftObjectPtr<AWaterZone> FindWaterZone3D(const UWorld* World, const FBox& Bounds, const TSoftObjectPtr<const ULevel> PreferredLevel = {});
