...
public:
	...
	//수정 - 추가.
	UE_API FVector GetZoneExtent3D() const;
	...
	// 수정 - 런타임 때 WaterInfoTextureArray를 사용할 수 없어서 한번 Transient 매크로 제거해봄.
...
private:
	...
	// ZoneExtent자체를 3d로 고치려면 여러 군데 손봐야되서 높이를 따로 추가. 
	UPROPERTY(Category = Water, EditAnywhere, BlueprintReadWrite, meta = (AllowPrivateAccess = "true"))
	double CharonZoneExtentZ = 16384.;
	//
